WITH stats AS (
    SELECT *
    FROM {{  ref('fct_player_stats_per_100')  }}
)
, eligible AS (
    SELECT s.*
    FROM stats s
...
SELECT s.player_id, s.team_id, s.season, s.league_id, s.season_type, s.games_played
    , r.pts_per_100_percentile
    , r.fgm_per_100_percentile
    , r.fga_per_100_percentile
    , r.fg_pct_percentile

    , r.fg3m_per_100_percentile
    , r.fg3a_per_100_percentile
    , r.fg3_pct_percentile

    , r.fg3pr_percentile

    , r.fg2m_per_100_percentile
    , r.fg2a_per_100_percentile
    , r.fg2_pct_percentile

    , r.ftm_per_100_percentile
    , r.fta_per_100_percentile
    , r.ft_pct_percentile
    , r.ftr_percentile

    , r.oreb_per_100_percentile
    , r.dreb_per_100_percentile
    , r.reb_per_100_percentile
    , r.ast_per_100_percentile

    , r.stl_per_100_percentile
    , r.blk_per_100_percentile
    , r.stk_per_100_percentile
    , r.tov_per_100_percentile
    , r.pf_per_100_percentile
